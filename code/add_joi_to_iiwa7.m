function chain_model = add_joi_to_iiwa7(chain_model,varargin)
%
...
addParameter(p,'hand_size',0.15);
addParameter(p,'wrist_size',0.3);
addParameter(p,'elbow_size',0.3);
addParameter(p,'shoulder_size',0.3);
addParameter(p,'torso_size',0.4);
addParameter(p,'foot_size',0.3);
addParameter(p,'ankle_size',0.3);
addParameter(p,'knee_size',0.3);
addParameter(p,'pelvis_size',0.3);
addParameter(p,'head_size',0.3);
